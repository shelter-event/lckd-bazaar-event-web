...
export const puppyParameters = [
  new PuppyParameter(
    ...
    '사람과 발 맞춰 걸을 줄 아는 똑똑한 친구예요. 큰소리를 무서워하고 비오는 날의 산책은 좋아하지 않아요',
  ...
  new PuppyParameter(
    ...
    '산책을 좋아하지만 집중해주세요! 줄을 놓칠 수 있어요. 큰소리를 무서워하고 비오는 날의 산책은 좋아하지 않아요.',
    '목욕을 비롯한 미용, 귀청소, 옷 입을때도 잘 따라요',
    false,
  ),
  new PuppyParameter(
    ...
    '비가 와도 산책이 좋아요. 몸집이 커서 산책 훈련은 필수! (간식 욕심이 있어 훈련하면 빨리 익혀요!)',
  ...
  new PuppyParameter(
    ...
    '현재 고양이를 보면 흥분해서 이중 리드줄을 하고 산책 가요. 그걸 제외하고는 신호등도 리드줄 신호도 잘 지켜요',
  ...
  new PuppyParameter(
    ...
    '줄당김이 조금 있는 편, 간식에 대한 집중력이 좋아 콜링이 꽤 되는 편입니다. ',
    '미용도 목욕도 잘하는 편이에요 ',
    false,
  ),
  new PuppyParameter(
    8, '깜순', '#23_0080',
    require('../../assets/main/puppies/modal_profile/깜순.webp'),
    require('../../assets/main/puppies/front_profile/깜순.webp'),
    null,
    '자기보다 작거나 어린 친구들과 잘 놀아주는 착한 언니스타일!',
    '사람에겐 낯가림이 조금 심해요. 하지만, 마음을 열면 누구부다 애교쟁이가 된답니다.',
    '친구들이랑 뛰어노는걸 정말 좋아해요.',
    '가끔 어려움. 친구들을 보면 같이 가려고 줄당김이 있어요. 하지만 줄신호를 잘 따르는 편!',
  ...
  new PuppyParameter(
    ...
    null,
    '친구들은 조금 궁금해요! 조용조용 노는 스타일이랍니다.',
    '조금 낯가리지만 귀여움 받는 걸 은근 즐기고 좋아해요!',
    null,
    '조금 어려움. 아직 작은 소리에도 깜짝 놀라 도망갈 수 있으니 주의해야 해요! 친구들이랑 가는게 좋아요.',
    null,
    false,
  ),
  // new PuppyParameter(
  //   10, '햇살', '#LCKD???',
  //   require('../../assets/main/puppies/modal_profile/햇살.webp'),
  //   require('../../assets/main/puppies/front_profile/햇살.webp'),
  //   null,
  //   null,
  //   null,
  //   null,
  ...
  // new PuppyParameter(
  //   11, '쿠키', '#LCKD???',
  //   require('../../assets/main/puppies/modal_profile/쿠키.webp'),
  //   require('../../assets/main/puppies/front_profile/쿠키.webp'),
  //   null,
  //   null,
  //   null,
  //   null,
