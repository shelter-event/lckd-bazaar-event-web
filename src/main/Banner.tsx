...
const Banner = () => {
  ...
  >
    ...
    <div className={styles.textBox}>
      <h1 className={styles.title} aria-label='2023년 11월 4일 토요일, 태평역 인근 카페에서 진행하는 LCKD 유기견 후원 바자회에 초대합니다.'>
        {isPc ? 'LCKD의 유기견들과 함께하는' : ''}
        {isPc ? <br /> : <></>}
        유기견 후원 <span className={styles.mainColor}>바자회</span>에 초대합니다.
      </h1>
      <span className={styles.name} aria-label='2023년 11월 4일 토요일, 태평역 인근 카페에서 비영리민간단체 유기동물 보호소인 LCKD가 진행합니다.'>
        장소: 태평역 인근 카페<br />
